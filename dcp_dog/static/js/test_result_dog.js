...
lib.ssMetadata = [
		{name:"test_result_dog_atlas_1", frames: [[928,1083,924,139],[0,1083,926,141],[928,1224,924,139],[0,1226,924,139],[926,1365,924,139],[0,0,1921,1081]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(0,0,0.4707,0.4707);

	this.instance_2 = new lib.CachedBmp_3();
	this.instance_2.setTransform(0,0,0.4707,0.4707);

	this.instance_3 = new lib.CachedBmp_5();
	this.instance_3.setTransform(0,0,0.4707,0.4707);

	this.instance_4 = new lib.CachedBmp_4();
	this.instance_4.setTransform(-0.45,-0.45,0.4707,0.4707);
...
p.nominalBounds = new cjs.Rectangle(-0.4,-0.4,435.79999999999995,66.30000000000001);
...
if (reversed == null) { reversed = false; }
	...
	this.golist_btn.setTransform(1639.05,1018.4,1.0623,1.0623,0,0,0,217.5,32.6);
	new cjs.ButtonHelper(this.golist_btn, 0, 1, 2, false, new lib.golist_btn(), 3);

	this.instance = new lib.結果圖1影像();
	this.instance.setTransform(0,0,0.999,0.999);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance},{t:this.golist_btn}]}).wait(30));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(960,540,959,539.9000000000001);
// library properties:
lib.properties = {
